...
.resize-handle {
  position: absolute; left: -2px; top: 0; bottom: 0; width: 4px; cursor: col-resize; z-index: 50; transition: background 0.2s; 
}
...
.close-panel-btn {
  background: transparent; border: none; color: #94a3b8; cursor: pointer; padding: 4px; border-radius: 4px; display: flex; align-items: center;
}
.close-panel-btn:hover { background: #f1f5f9; color: #ef4444; }

.footer-label {
  font-size: 10px; font-weight: 800; color: #64748b; text-transform: uppercase; cursor: pointer; margin-left: 8px;
}

.empty-props { 
  height: 100%; display: flex; flex-direction: column; align-items: center; justify-content: center; color: #94a3b8; font-size: 0.8rem; position: relative;
}

.prop-section-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem; }
